...
public class RemoveContactFromGroupTests : UnitTest
{
	private readonly IResourceScope _resources;
	private readonly IServiceProvider _serviceProvider;

	public RemoveContactFromGroupTests(ITestOutputHelper testOutputHelper, UnitDependencyContainerFixture container,
	...
	[Fact]
	public async Task RemovesContactFromGroup()
	{
		...
		await mediator.Send(new RemoveContactFromGroup(3));
